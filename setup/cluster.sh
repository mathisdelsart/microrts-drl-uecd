...
echo "#  SETUP COMPLETE.                                                            #"
echo "#                                                                             #"
echo "#  THE VENV IS NOT ACTIVATED IN YOUR SHELL YET. Run this in your terminal:   #"
echo "#                                                                             #"
echo "#      source $VENV_DIR/bin/activate"
echo "#                                                                             #"
echo "#  (A bash script runs in a subshell; any 'source' inside it dies with the   #"
echo "#   script. You MUST source the activate line yourself in the parent shell.) #"
echo "#                                                                             #"
