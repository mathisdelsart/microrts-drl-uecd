...
| [`cog-2026-paper/`](cog-2026-paper/) | CoG 2026 accepted short paper (IEEEtran, single-file LaTeX) | [README](cog-2026-paper/README.md) |
| [`defense/`](defense/) | Beamer slide deck for the 20-minute oral defense (single-file `metropolis` source + compiled PDF + figure scripts) | [README](defense/README.md) |
